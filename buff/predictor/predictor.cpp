 ...
 * @return 是否预测成功
*/
bool Predictor::predict(double speed, int dist, int timestamp, double &result)
{
 ...
 * @return 角度提前量(rad)
*/
double Predictor::calcAimingAngleOffset(double params[4], double t0, double t1)
{
    auto a = params[0];
    auto omega = params[1];
    auto theta = params[2];
 ...
 * @return double 滤波结果
 */
inline double Predictor::shiftWindowFilter(int start_idx=0)
{
